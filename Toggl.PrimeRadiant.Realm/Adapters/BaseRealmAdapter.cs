...
namespace Toggl.PrimeRadiant.Realm
{
    ...
    internal abstract class BaseRealmAdapter<TRealmEntity, TModel> : IRealmAdapter<TModel>
        ...
        where TModel : IDatabaseSyncable
    {
        ...
        private readonly Func<TRealmEntity, TModel, bool> matchEntity;
        
        public BaseRealmAdapter(Func<TModel, Realms.Realm, TRealmEntity> convertToRealm, Func<TRealmEntity, TModel, bool> matchEntity)
        {
            ...
            TModel entity, Func<Realms.Realm, TRealmEntity, TRealmEntity> transactionAction, bool checkExistance)
        {
            ...
            using (var transaction = realm.BeginWrite())
            {
                ...
                if (checkExistance)
                {
                    ...
                    realm.All<TRealmEntity>().Single(x => matchEntity(x, entity));
                }
